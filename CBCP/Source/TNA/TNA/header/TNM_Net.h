...
public:
	...
	floatType           aux_volume1;  /*link volume for traffic assignment 1*/
    floatType           aux_volume2;  //link volume for traffic assignment 2
...
public:
	...
	floatType           GetDer2Cost(bool ftoll = false);
...
////define a new link type for the bcpcc problem
//class TNM_EXT_CLASS TNM_BCPLK :	public TNM_SLINK
//{
//public:
////constructors and destructor
//	TNM_BCPLK(void) {alpha = 0.15; beta = 4.0; type = BCPLK;}
//	virtual ~TNM_BCPLK(void) {;}
//
//	virtual bool		Initialize(const LINK_VALCONTAINER cont); //the first of cont.par is given to alpha, the other is given to beta.
//	//void                SetAlpha
//	
...
public:
	...
	vector<TNM_SPATH*> aux_pathSet1; //pathset for the traffic assignment 1
	vector<TNM_SPATH*> aux_pathSet2; //pathset for the traffic assignment 2;
...
public:
	...
	void				 Reset2();	//set all link volume as zero, update its link cost as the free flow cost
									//empty path set for all O-D pair; but not delete the path ptr
