...
PTNet_API bool     TNM_OpenInFile(ifstream &, const string &);    //open a ascii file to read command
PTNet_API bool     TNM_OpenOutFile(ofstream &, const string &);   //open a ascii file to write command
PTNet_API ifstream &TNM_SkipString(ifstream &, int count); //frequently used function in io function.																										 
PTNet_API void		TNM_GetWordsFromLine(const string &pstr, vector<string> &words, const char dimi, const char exception = ' ');
PTNet_API void		TNM_GetWordsFromLine(string &pstr, vector<string> &words);
PTNet_API string	GetSourcePath();

/*============================================================================================
            parameterized stream operator
  ===========================================================================================*/
struct PTNet_API TNM_FloatFormat 
{
...
PTNet_API ostream& operator <<(ostream& os, const TNM_FloatFormat& m); 

struct PTNet_API TNM_IntFormat 
{
...
PTNet_API ostream& operator <<(ostream& os, const TNM_IntFormat& m); 
typedef std::set<int, std::less<int> > INT_SET;
class  PTNet_API IDManager
{
public:
	IDManager();
	~IDManager(){;}
...
class PTNet_API TNM_MyDateTime
{
public:
    TNM_MyDateTime();    
