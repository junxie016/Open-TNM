...
public:
	...
	vector<PATHELEM*>  pathElemVector;// Add for SBA
...
public:
	...
	vector<floatType>  pathSetbound; //Add for SBA
	vector<TNM_SPATH*> rdmSet;// Add for SBA
};
...
{
	int					ID;
	vector<TNM_SNODE*>	MCnodeset;//
};

//the network of multi-class assignment
class TNM_EXT_CLASS TNM_MCNET: public TNM_SNET
{
public:
	TNM_MCNET();
	~TNM_MCNET();
	...
	int                 numOfmcNode;
	int                 numOfmcLink;
	vector<TNM_SNET*>	netvector;
	vector<MClink*>		mclinkvector;
	vector<MCnode*>		mcnodevector;
