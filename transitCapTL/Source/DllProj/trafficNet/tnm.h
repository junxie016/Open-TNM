...
//#pragma unmanaged
	...
	//	#if defined(_M_IX86)
	//		#ifdef _DEBUG
	//			#pragma message("     _Adding library: tnmd.lib: debug, Win32" ) 
	//			#pragma comment(lib, "tnmd.lib")
	//		#else
	//			#pragma message("     _Adding library: tnm_win32.lib: release, Win32" ) 
	//			#pragma comment(lib, "tnm_win32.lib")
	//		#endif
	//	#else
	//		#ifdef _DEBUG
	//			#pragma message("     _Adding library: tnm.lib: debug, Win64" ) 
	//			#pragma comment(lib, "tnmd64.lib")
	//		#else
	//			#pragma message("     _Adding library: tnm64.lib: release, Win64" ) 
	//			#pragma comment(lib, "tnm_x64.lib")
	//		#endif
	//	#endif
	//#endif
	//#endif
